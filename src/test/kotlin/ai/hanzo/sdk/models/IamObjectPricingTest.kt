...
class IamObjectPricingTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of IamObjectPricing
        //val modelInstance = IamObjectPricing()
        ...
        // to test the property `trialDuration`
        should("test trialDuration") {
            // uncomment below to test the property
            //modelInstance.trialDuration shouldBe ("TODO")
        }
