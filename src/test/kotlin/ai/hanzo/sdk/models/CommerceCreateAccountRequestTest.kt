...
class CommerceCreateAccountRequestTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CommerceCreateAccountRequest
        //val modelInstance = CommerceCreateAccountRequest()
