...
data class ConsoleTraceWithFullDetails (
    ...
    val observations: kotlin.collections.List<ConsoleObservation>? = null,

    @Json(name = "scores")
    val scores: kotlin.collections.List<ConsoleScore>? = null
